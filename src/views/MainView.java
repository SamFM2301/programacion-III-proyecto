...
public class MainView extends JFrame {
    ...
    private void initComponents() {
        ...
        homePanel.setBackground(AppColors.PANEL);

        // PANEL CALENDARIO GRANDE
        JPanel calendarContainer = new JPanel(new BorderLayout());
        calendarContainer.setBackground(AppColors.PANEL);
        calendarContainer.setBorder(new EmptyBorder(20, 20, 20, 20));

        JPanel calendarPanel = new JPanel(new GridLayout(0, 7, 10, 10));
        calendarPanel.setBackground(AppColors.PANEL);
        ...
        for (String day : days) {
            ...
            dayHeader.setBackground(AppColors.YELLOW);
            dayHeader.setPreferredSize(new Dimension(100, 60));

            JLabel lblDay = new JLabel(day, SwingConstants.CENTER);

            lblDay.setForeground(AppColors.TEXT_DARK);
            lblDay.setFont(AppFonts.bold(18));
        ...
        for (int i = 1; i <= 31; i++) {
            ...
            dayPanel.setBackground(AppColors.FIELDS);
            ...
            lblNumber.setForeground(AppColors.TEXT_LIGHT);
            lblNumber.setFont(AppFonts.bold(20));

            dayPanel.add(lblNumber, BorderLayout.NORTH);

            calendarPanel.add(dayPanel);
        }

        calendarContainer.add(calendarPanel, BorderLayout.CENTER);
        homePanel.add(calendarContainer, BorderLayout.CENTER);
        // =========================
        // PANEL USUARIOS
        // =========================
        ...
        addHover(
                btnAdd,
                AppColors.YELLOW,
                AppColors.YELLOW_HOVER
        );

        addHover(
                btnModify,
                AppColors.FIELDS,
                AppColors.FIELDS_HOVER
        );
